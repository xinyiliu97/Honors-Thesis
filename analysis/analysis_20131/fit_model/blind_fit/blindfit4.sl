...
() = open_plot("fit_all_lines_voigt4.ps/cps", 1, 2);
fp = fopen("alllinefits_voigt4.txt", "w");
...
lam = [4.5, 5.5];
() = evalfile("fit_line_voigt.sl");
save_par("voigt4_1.txt");

lines = [6.4, 6.7, 6.88, 6.9, 6.97, 7.2];
guess_flux = [400, 200, 80, 300, 200, 50];
lam = [5.5, 7.5];
() = evalfile("fit_line_voigt.sl");
save_par("voigt4_2.txt");
