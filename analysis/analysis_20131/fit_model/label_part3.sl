...
set_par("redshift(2).z", 0.088195, 0, 0.08, 0.12);
...
%save_par("fit_alllines3.txt");


load_par("fit_alllines3.txt");
set_fit_statistic("cash");
() = fit_counts(;fit_verbose=1);
...
%   prefix="conf_loop/pars_all3", num_slaves=7);
