...
set_par("redshift(2).z", 0.087753, 0, 0.04, 0.12);
...
%save_par("fit_allline1.txt");

set_fit_statistic("cash");
load_par("fit_alllines0.txt");
() = fit_counts(;fit_verbose=1);
