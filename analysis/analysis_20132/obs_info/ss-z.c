...
int main (void) 
{
	...
	/*sc_maxmjd = 58340.75083; /* Chandra visibility ends   */
        sc_minmjd = 58344.54172910;
        sc_maxmjd = 58344.76992804;

	phi_o_min = 0.78;    /* Start HETG at this phi_o  */
	phi_o_max = 0.97;    /* End HETG at this phi_o    */
	...
	mjdstep=0.1;
        ...
        /*mjd = 58344.54172910; /*start of 20131 part 2*/
	mjd = 58344.54172910; /*Start of 20132*/
	mjd = 58344.76992804; /*End of 20132 */
	...
	for (mjd = sc_minmjd; mjd < sc_maxmjd; mjd+=mjdstep) 
	{
		...
		fprintf(op,"%f %f %f %d %d %d\n", 
				mjd, zred, zblu, gti_orb, gti_pre, gti_final);
	}
	fclose(op);
