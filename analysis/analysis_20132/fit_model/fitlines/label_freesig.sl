...
%save_par("fit_alllines_freesig.txt");

%load_par("fit_alllines_freesig.txt");
%() = eval_counts();
%() = fit_counts(;fit_verbose=1);
...
wpar = [1,2,3,4,5,24,25,26,28,29,31,32,34,35,37,38,40,41,43,44,46,47,49,50,52,53,55,56,58,59,61,62,64,65,67,68,70,71,73,74,76,77,79];
npar = length(wpar);

fp = fopen ("all_paramvalues3.txt", "w");
